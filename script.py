...
Here's a bunch of tools to help you better your wordle game.
    MENU:
        ...
        3 - enter five letters and find every word with the combination
        4 - enter 15 letters and find 3 words that include them all
        0 - exit
    ...
    match(order):
        ...
        case 3:
            ...
            if (len(let) == 5):
                ...
                print("invalid input")
        case 4:
            print("enter 15 letters (no spaces between them)")
            let = input()
            if (len(let) == 15):
                letters = list(let)
                result = find_three_five_letter_words(words_list, letters)
